...
import com.bbva.dataprocessors.transformers.GroupByForeignKeyTransformer;
...
public class GroupByFKStateBuilder<K, V extends SpecificRecord> implements StateDataflowBuilder {
    ...
    public GroupByFKStateBuilder(final String sourceChangelogTopicName, final Class<K> keyClass, final Class<V> valueClass, final String foreignKeyFieldName) {
    ...
    public void build() {
        ...
        builder
                ...
                .transform(() -> new GroupByForeignKeyTransformer<>(listStore.name(), foreignKeyFieldName, valueClass), listStore.name())
