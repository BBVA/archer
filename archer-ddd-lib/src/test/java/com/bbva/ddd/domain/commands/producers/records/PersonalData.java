...
public class PersonalData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public static com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder newBuilder() {
        return new com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder();
    }
     ...
     * @return A new PersonalData RecordBuilder
     */
    public static com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder newBuilder(final com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder other) {
        return new com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder(other);
    }
     ...
     * @return A new PersonalData RecordBuilder
     */
    public static com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder newBuilder(final com.bbva.ddd.domain.commands.producers.records.PersonalData other) {
        return new com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonalData>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(final com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(final com.bbva.ddd.domain.commands.producers.records.PersonalData other) {
            super(SCHEMA$);
         ...
         * @return This builder.
         */
        public com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder setPersonalData(final PersonalData value) {
         ...
         * @return This builder.
         */
        public com.bbva.ddd.domain.commands.producers.records.PersonalData.Builder clearPersonalData() {
            personalData = null;
