...
/**
 * Looks up StreamsMetadata from KafkaStreams and converts the results into Beans that can be JSON serialized via
 * Jersey.
 */
public class MetadataService {
    ...
    /**
     * Find the metadata for the instance of this Kafka Streams Application that has the given store and would have the
