...
public class LoggerInterceptorTest {
    ...
    public void infoTraces() {
        ...
        logger.info("test formatted %s", "test");
        logger.info("test formatted %s %s", "test", "test2");
        logger.info("test formatted %s %s", new Object[]{"test", "test2"});
        logger.info(marker, "info msg");
        logger.info(marker, "info msg", new Throwable());
        logger.info(marker, "test formatted %s", "test");
        logger.info(marker, "test formatted %s %s", "test", "test2");
        logger.info(marker, "test formatted %s %s", new Object[]{"test", "test2"});
    ...
    public void warnTraces() {
        ...
        logger.warn("test formatted %s", "test");
        logger.warn("test formatted %s %s", "test", "test2");
        logger.warn("test formatted %s %s", new Object[]{"test", "test2"});
        logger.warn(marker, "info msg");
        logger.warn(marker, "info msg", new Throwable());
        logger.warn(marker, "test formatted %s", "test");
        logger.warn(marker, "test formatted %s %s", "test", "test2");
        logger.warn(marker, "test formatted %s %s", new Object[]{"test", "test2"});
    ...
    public void errorTraces() {
        ...
        logger.error("test formatted %s", "test");
        logger.error("test formatted %s %s", "test", "test2");
        logger.error("test formatted %s %s", new Object[]{"test", "test2"});
        logger.error(marker, "info msg");
        logger.error(marker, "info msg", new Throwable());
        logger.error(marker, "test formatted %s", "test");
        logger.error(marker, "test formatted %s %s", "test", "test2");
        logger.error(marker, "test formatted %s %s", new Object[]{"test", "test2"});
    ...
    public void debugTraces() {
        ...
        logger.debug("test formatted %s", "test");
        logger.debug("test formatted %s %s", "test", "test2");
        logger.debug("test formatted %s %s", new Object[]{"test", "test2"});
        logger.debug(marker, "info msg");
        logger.debug(marker, "info msg", new Throwable());
        logger.debug(marker, "test formatted %s", "test");
        logger.debug(marker, "test formatted %s %s", "test", "test2");
        logger.debug(marker, "test formatted %s %s", new Object[]{"test", "test2"});
    ...
    public void traceTraces() {
        ...
        logger.trace("test formatted %s", "test");
        logger.trace("test formatted %s %s", "test", "test2");
        logger.trace("test formatted %s %s", new Object[]{"test", "test2"});
        logger.trace(marker, "info msg");
        logger.trace(marker, "info msg", new Throwable());
        logger.trace(marker, "test formatted %s", "test");
        logger.trace(marker, "test formatted %s %s", "test", "test2");
        logger.trace(marker, "test formatted %s %s", new Object[]{"test", "test2"});
