...
@PrepareForTest({UniqueFieldStateBuilder.class, DataflowProcessorBuilder.class, TopicManager.class, StreamsBuilder.class})
public class UniqueFieldStateBuilderTest {
    ...
    public void createDataProcessorBuild() {
        ...
        Assertions.assertThrows(ApplicationException.class, () -> {
            final UniqueFieldStateBuilder entityStateBuilder = new UniqueFieldStateBuilder("snapshot", "name", String.class, String.class);
    ...
    public void createDataProcessorStart() throws Exception {
        ...
        dataflowProcessorBuilder.init(context);
        dataflowProcessorBuilder.start();
        dataflowProcessorBuilder.close();

        Assertions.assertAll("dataProcessor",
                () -> Assertions.assertNotNull(dataflowProcessorBuilder),
                () -> Assertions.assertNull(dataflowProcessorBuilder.getName()),
                () -> Assertions.assertNotNull(dataflowProcessorBuilder.streams())
        );
    }
